...
$txt[1006] = 'Затвори прозор';

$helptxt['manage_boards'] = '
	<b>Управљање форумима</b><br />
	У овом менију можете да направите/промените распоред/уклоните форуме и категорије изнад њих.
	На пример, ако бисте имали свеобухватни сајт који нуди информације из &quot;Спорта&quot;, &quot;Аутомобила&quot; и &quot;Музике&quot;,
	ово би биле категорије које бисте направили. Под сваком од ових категорија вероватно бисте желели
	да направите &quot;под-категорије&quot; илити &quot;форуме&quot; за сваку тему унутар њих. То је проста хијерархија са овом структуром: <br />
	<ul>
		<li>
			<b>Спортови</b>
			&nbsp;- &quot;категорија&quot;
		...
		<ul>
			<li>
				<b>Кошарка</b>
				&nbsp;- форум категорије &quot;Спортови&quot;
			</li>
			<ul>
				<li>
					<b>Статистика</b>
					&nbsp;- подфорум форума &quot;Кошарка&quot;
				</li>
			</ul>
			<li><b>Фудбал</b>
			&nbsp;- форум категорије &quot;Спортови&quot;</li>
		</ul>
	</ul>
