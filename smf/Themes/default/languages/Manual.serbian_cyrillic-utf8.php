...
$txt['manual_index_you_have_arrived_part1'] = 'Значи, стигли сте на овај ';
$txt['manual_index_you_have_arrived_link_site0'] = 'Simple Machines форум';
$txt['manual_index_you_have_arrived_part2'] = ' (SMF)! Можда сте гледали ';
$txt['manual_index_you_have_arrived_link_site0_board'] = 'почетну страницу';
$txt['manual_index_you_have_arrived_part3'] = ' или страницу на којој сте сазнали да морате да се региструјете уколико желите да је прегледате и запитали сте се - шта даље?';
$txt['manual_index_guest_permit_read_part1'] = 'Па, неки форуми допуштају гостима да читају и пишу поруке, неки гостима дозвољавају само читање док су неки доступни само регистрованим корисницима. Ми вам препоручујемо ';
$txt['manual_index_guest_permit_read_link_registering'] = 'регистровање';
$txt['manual_index_guest_permit_read_part2'] = ' на било који форум који редовно користите јер ће вам многе корисне могућности бити доступне тек када то учините. Пошто је SMF тако прилагодљив систем да ћете тешко успети да нађете два иста форума, почећемо описивањем четири кључних области за које очекујемо да ће вам највероватније бити доступне:';
$txt['manual_index_main_menu'] = 'Главни мени';
$txt['manual_index_suppossing_guest'] = 'Ако претпоставимо да сте овде стигли као гост (или сте регистровани али тренутно нисте пријављени), главни мени (који се појављује на свакој страници) се најчешће састоји од пет или шест дугмади (или текстуалних линкова):';
$txt['manual_index_home_desc_part1'] = '<strong>Почетна</strong>, који вас враћа на ';
$txt['manual_index_home_desc_link_board'] = 'почетну страницу';
$txt['manual_index_home_desc_part2'] = '.';
$txt['manual_index_help_desc'] = '<strong>Помоћ</strong>, који вам приказује овај водич.';
$txt['manual_index_search_desc_part1'] = '<strong>Претрага</strong>, који вам дозвољава да ';
$txt['manual_index_search_desc_link_searching'] = 'претражујете';
$txt['manual_index_search_desc_part2'] = ' форуме за одређене кључне речи.';
$txt['manual_index_calendar_desc_part1'] = '<strong>Календар</strong>, који вас води на ';
$txt['manual_index_calendar_desc_link_posting_calendar'] = 'календар форума';
$txt['manual_index_calendar_desc_part2'] = ' (ако је омогућен).';
$txt['manual_index_login_desc_part1'] = '<strong>Пријављивање</strong>, који вам дозвољава да се ';
$txt['manual_index_login_desc_link_loginout'] = 'пријавите';
$txt['manual_index_login_desc_part2'] = ' ако сте се раније регистровали.';
$txt['manual_index_register_desc_part1'] = '<strong>Регистрација</strong>, помоћу којег можете да се ';
$txt['manual_index_register_desc_link_registering'] = 'региструјете';
$txt['manual_index_register_desc_part2'] = ' (или понекад пријавите за регистрацију) када пожелите да то урадите.';
$txt['manual_index_once_registered'] = 'Када се региструјете и пријавите, главни мени би требало да изгледа мало другачије:';
$txt['manual_index_home_reg'] = '<strong>Почетна</strong> (као и раније).';
$txt['manual_index_help_reg'] = '<strong>Помоћ</strong> (као и раније).';
$txt['manual_index_search_reg'] = '<strong>Претрага</strong> (као и раније).';
$txt['manual_index_profile_reg_part1'] = '<strong>Профил</strong>, који вам дозвољава да извршите промене на свом ';
$txt['manual_index_profile_reg_link_profile'] = 'профилу';
$txt['manual_index_profile_reg_part2'] = '.';
$txt['manual_index_calendar_reg'] = '<strong>Календар</strong> (као и раније).';
$txt['manual_index_logout_reg_part1'] = '<strong>Одјави се</strong>, који вам дозвољава да се ';
$txt['manual_index_logout_reg_link_loginout_logout'] = 'одјавите';
$txt['manual_index_logout_reg_part2'] = ' ако то желите.';
$txt['manual_index_forum_admins_note_presentation'] = 'Администратори форума би требали да примете присуство додатног дугмета <strong>Администратор</strong>.';
$txt['manual_index_sec_board_index'] = 'Почетна страна форума';
$txt['manual_index_sec_board_index_def'] = 'Иако почетна страна форума садржи различите врсте информација и линкова, језгро интерфејса (барем у подразумеваној теми SMF-а) би требало да буде налик овом:';
$txt['manual_index_forum_name'] = 'Име форума';
$txt['manual_index_cat_name'] = 'Име категорије';
$txt['manual_index_board_name'] = 'Име форума';
$txt['manual_index_board_desc'] = 'Опис форума';
$txt['manual_index_topics_posts'] = 'Број тема и порука послатих у овом форуму';
$txt['manual_index_date_time'] = 'Датум, време, тема и аутор последње поруке';
$txt['manual_index_new_posts'] = 'Нове поруке';
$txt['manual_index_no_new'] = 'Нема нових порука';
$txt['manual_index_mark_read'] = 'Означи СВЕ поруке као прочитане';
$txt['manual_index_f_name'] = '<strong>Име форума</strong> линкује ка врху почетне стране форума.';
$txt['manual_index_cat'] = 'Ако је <strong>категорија</strong> скупљива (приказано по малој стрелици), клик на име категорије ће скупити односно раширити дотичну категорију.';
$txt['manual_index_b_name_part1'] = '<strong>Име форума</strong> линкује ка ';
$txt['manual_index_b_name_link_message'] = 'списку порука';
$txt['manual_index_b_name_part2'] = ' дотичног форума.';
$txt['manual_index_b_desc'] = '<strong>Опис форума</strong> описује садржај форума а може да укључује и линкове ка подфорумима и/или приказује уредника(е) форума.';
$txt['manual_index_n_no_n_posts'] = 'Иконе <strong>нове поруке</strong> и <strong>нема нових порука</strong> које се налазе са леве стране, приказују регистрованим члановима да ли има неких нових порука у форуму од прошлог читања.';
$txt['manual_index_m_read'] = 'Дугме <strong>означи све поруке као прочитане</strong> омогућује регистрованим члановима да означе све поруке на целом форуму као \'прочитане\'.';
$txt['manual_index_sec_msg_index'] = 'Приказ форума';
$txt['manual_index_sec_msg_index_def'] = 'Слично почетној страни форума, интерфејс приказа форума је веома једноставан ако се растави на основне компоненте:';
$txt['manual_index_pages'] = 'Странице';
$txt['manual_index_mark_read_this_board'] = 'Означи теме у овом форуму као прочитане';
$txt['manual_index_ru_sure_notify'] = 'Да ли сте сигурни да желите да омогућите обавештења о новим темама за овај форум?';
$txt['manual_index_notify'] = 'Обавести';
$txt['manual_index_start_new'] = 'Нова тема';
$txt['manual_index_new_poll'] = 'Ново гласање';
$txt['manual_index_subject'] = 'Тема';
$txt['manual_index_started_by'] = 'Започео';
$txt['manual_index_replies'] = 'Одговора';
$txt['manual_index_views'] = 'Прегледа';
$txt['manual_index_last_post'] = 'Последња порука';
$txt['manual_index_topic_subject'] = 'Наслов теме';
$txt['manual_index_new'] = 'Ново';
$txt['manual_index_topic_starter'] = 'Покретач теме';
$txt['manual_index_last_poster'] = 'Датум, време и аутор последње поруке';
$txt['manual_index_normal_post'] = 'Тема у којој сте одговарали';
$txt['manual_index_normal_topic'] = 'Нормална тема';
$txt['manual_index_hot_post'] = 'Популарна тема (Више од 15 порука)';
$txt['manual_index_very_hot_post'] = 'Веома популарна тема (Више од 25 порука)';
$txt['manual_index_locked'] = 'Закључана тема';
$txt['manual_index_sticky'] = 'Лепљива тема';
$txt['manual_index_poll'] = 'Гласање';
$txt['manual_index_jump_to'] = 'Пребаци се на';
$txt['manual_index_destination'] = 'Изаберите дестинацију';
$txt['manual_index_another_board'] = 'Други форум';
$txt['manual_index_go'] = 'Иди';
$txt['manual_index_nav_tree'] = 'Неки форуми приказују <strong>навигационо дрво</strong> при врху у хоризонталном моду који чува простор.';
$txt['manual_index_page_number'] = '<strong>Бројеви страница</strong> линкују ка даљим страницама форума и могу бити праћене линковима <strong>иди горе</strong> и <strong>иди доле</strong> који линкују ка врху и дну тренутне стране.';
$txt['manual_index_mark_read_button'] = 'Дугме <strong>означи као прочитано</strong> омогућује регистрованим корисницима да означе све поруке у тренутном форуму као \'прочитане\'.';
$txt['manual_index_notify_button'] = 'Дугме <strong>обавести</strong> омогућује регистрованим корисницима да се претплате на e-mail обавештења о одговорима у темама овог форума.';
$txt['manual_index_new_topic_poll_button_part1'] = 'Дугмад <strong>нова тема</strong> и <strong>ново гласање</strong> покрећу нове теме и гласања као што је описано у ';
$txt['manual_index_new_topic_poll_button_link_posting'] = 'помоћи приликом слања';
$txt['manual_index_new_topic_poll_button_part2'] = '.';
$txt['manual_index_subject_replies_etc'] = 'Линкови <strong>наслов</strong>, <strong>започео</strong>, <strong>одговора</strong>, <strong>прегледа</strong> и <strong>последња порука</strong> омогућују вам сортирање колона по овим параметрима (при чему <strong>последња порука</strong> може да буде поређана по опадајућем или растућем реду као што је приказано стрелицом).';
$txt['manual_index_topic_icons'] = '<strong>Иконе тема</strong> у колони са леве стране су објашњене следећом ставком.';
$txt['manual_index_post_icons'] = '<strong>Иконе порука</strong> у следећој колони се понекад користе да привуку пажњу на расположење или сврху теме.';
$txt['manual_index_topic_subject_links_part1'] = '<strong>Наслов теме</strong> линкује ка почетку ';
$txt['manual_index_topic_subject_links_link_topic'] = 'теме';
$txt['manual_index_topic_subject_links_part2'] = ', са додатним линковима ка одређеним страницама теме или дугметом <strong>ново</strong> који регистроване кориснике води право до прве непрочитане поруке у теми.';
$txt['manual_index_where_topic_part1'] = 'Код тема које су започете или имају последњу поруку од регистрованог члана, њихова имена линкују ка њиховим ';
$txt['manual_index_where_topic_link_profile'] = 'профилима';
$txt['manual_index_where_topic_part2'] = '.';
$txt['manual_index_jump_to_menu'] = 'Мени <strong>пребаци се на</strong> пружа брз начин за навигацију по форуму.';
$txt['manual_index_sec_topic'] = 'Тема';
$txt['manual_index_ref_thread'] = '';
$txt['manual_index_reply'] = 'Одговор';
$txt['manual_index_ru_sure_enable_notify'] = 'Да ли сте сигурни да желите да омогућите обавештавање о новим одговорима у овом форуму?';
$txt['manual_index_mark_unread'] = 'Означи као непрочитано';
$txt['manual_index_send_topic'] = 'Пошаљи ову тему';
$txt['manual_index_print'] = 'Штампај';
$txt['manual_index_author'] = 'Аутор';
$txt['manual_index_topic'] = 'Тема';
$txt['manual_index_read_x_times'] = 'Прочитано x пута';
$txt['manual_index_view_author_profile'] = 'Погледајте профил аутора';
$txt['manual_index_member_group'] = 'Група члана';
$txt['manual_index_post_group'] = 'Група заснована на броју порука';
$txt['manual_index_post_count'] = 'Број порука';
$txt['manual_index_post_date_time'] = 'Датум и време поруке';
$txt['manual_index_reply_quote'] = 'Одговори са цитатом';
$txt['manual_index_topic_text'] = 'Ово је текст поруке због чега и јесмо овде, зар не?';
$txt['manual_index_smiley'] = 'Смајли';
$txt['manual_index_report_to_mod'] = 'Пријави уреднику';
$txt['manual_index_logged'] = 'Сачувана';
$txt['manual_index_view_profile'] = 'Погледај профил';
$txt['manual_index_email'] = 'E-mail';
$txt['manual_index_personal_msg'] = 'Приватна порука (Ван мреже)';
$txt['manual_index_navigation_tree'] = 'Неки форуми приказују <strong>навигационо дрво</strong> при врху у хоризонталном моду који чува простор.';
$txt['manual_index_prev_next'] = 'Неки форуми могу да буду подешени да приказују линкове ка <strong>претходним</strong> и <strong>следећим</strong> темама.';
$txt['manual_index_page_no_link'] = '<strong>Бројеви страница</strong> линкују ка даљим страницама теме и могу бити праћене линковима <strong>иди горе</strong> и <strong>иди доле</strong> који линкују ка врху и дну тренутне стране.';
$txt['manual_index_reply_button_part1'] = 'Дугме <strong>одговор</strong> вам омогућава да ';
$txt['manual_index_reply_button_link_posting_reply'] = 'пошаљете одговор';
$txt['manual_index_reply_button_part2'] = ' на тему.';
$txt['manual_index_notify_button_enables'] = 'Дугме <strong>обавести</strong> омогућава регистрованим члановима да се претплате на e-mail обавештења о одговорима на тему.';
$txt['manual_index_mark_unread_button'] = 'Дугме <strong>означи као непрочитано</strong> омогућава регистрованим члановима да означе тему као \'непрочитану\', што значи да ће она и даље бити приказана као нова и може се \'сачувати\' за касније читање. Напомена: ово дугме се мења у <strong>додај гласање</strong> у дугмадима која се налазе при дну за кориснике који имају дозволу да поставе ново гласање.';
$txt['manual_index_send_topic_button'] = 'Дугме <strong>пошаљи ову тему</strong> омогућава регистрованим корисницима да пошаљу линк ка теми у преко e-mail-а.';
$txt['manual_index_print_button'] = 'Дугме <strong>штампај</strong> прави поједностављени приказ странице, намењен штампању.';
$txt['manual_index_author_name_link_part1'] = '<strong>Име аутора</strong> линкује ка ';
$txt['manual_index_author_name_link_link_profile'] = 'профилу аутора';
$txt['manual_index_author_details'] = '<strong>Детаљи аутора</strong> у левој колони могу да буду праћени личним информацијама.';
$txt['manual_index_topic_subject_links_start'] = '<strong>Наслов теме</strong> линкује ка почетку теме.';
$txt['manual_index_quote_button_part1'] = 'Дугме <strong>цитирај</strong> вам омогућава да ';
$txt['manual_index_quote_button_link_posting_quote'] = 'цитирате';
$txt['manual_index_quote_button_part2'] = ' поруку.';
$txt['manual_index_modify_delete_part1'] = 'Дугмад <strong>измени</strong> и <strong>обриши</strong> пружају регистрованим члановима могућност да ';
$txt['manual_index_modify_delete_link_posting_modify'] = 'измене';
$txt['manual_index_modify_delete_part2'] = ' своје поруке.';
$txt['manual_index_report_to_moderator'] = '<strong>Пријави уреднику</strong> вам омогућава да пријавите узнемирујућу или погрешно постављену поруку особљу форума.';
$txt['manual_index_logged_IP'] = '<strong>Сачувана</strong> означава да је IP адреса аутора сачувана. IP адреса је доступна само администраторима форума.';
$txt['manual_index_jump_to_menu_provides'] = 'Мени <strong>пребаци се на</strong> пружа брз начин за навигацију по форуму.';
